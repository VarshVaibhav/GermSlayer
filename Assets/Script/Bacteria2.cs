...
public class Bacteria2 : MonoBehaviour
{
    ...
    public void LaunchBacteria2(float verticalVelocity, float xSpeed, float xStart)
    {
        IsActive = true;
        speed = xSpeed;
    ...
    public void Slice2()
    {
        ...
        Instantiate(Effect2, transform.position + transform.forward * -2, Quaternion.identity);
