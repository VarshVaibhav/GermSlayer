...
public class Bacteria4 : MonoBehaviour
{
    ...
    public void LaunchBacteria4(float verticalVelocity, float xSpeed, float xStart)
    {
        IsActive = true;
        speed = xSpeed;
    ...
    public void Slice4()
    {
        ...
        Instantiate(Effect4, transform.position + transform.forward * -2, Quaternion.identity);
